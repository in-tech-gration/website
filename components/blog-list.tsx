...
export default function BlogList({ blogPosts }:{ blogPosts: any }) {

  const searchParams = useSearchParams();
  const category = searchParams?.get('category'); // Read the category from the URL

  let filteredBlogPosts = !category
    ? blogPosts
    : blogPosts.filter(
        (post:any) => post && post.meta?.categories.includes(category)
      );
