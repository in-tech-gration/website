          ...
          <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-center space-y-8 md:space-y-0">
            ...
            <div className="md:w-1/2 md:pl-10 lg:pl-20">
              <div className="text-center md:text-left">
                ...
                <div>
                  {/* TODO: UPDATE LINK WHEN REPO GOES PUBLIC */}
                  <div
                    onClick={()=>{
                      alert("Our repository is still under heavy construction and switched to private mode. Please contact us, if you would like to gain read access to the beta and see what we are up to. :)");
                    }} 
                    className="btn font-bold text-white bg-black hover:bg-gray-800 shadow-md hover:shadow-lg cursor-pointer">
                  {/* <Link
                    target="_blank"
